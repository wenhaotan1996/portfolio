...
const cards = [
  ...
  },
  {
    ...
    image: '/EHTH_BIG.svg',
    imageClass: 'w-32 mb-4 xl:w-[200px] xl:mt-10',
...
export default function EducationAndExperience({}: Props) {
  return (
    <section
      ...
      <div className="flex flex-1 w-full cursor-pointer snap-x snap-mandatory space-x-5 overflow-x-auto py-4 lg:py-6 overflow-y-auto">
